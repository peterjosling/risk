...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = (function (_super) {
	    ...
	    Game.prototype.connect = function (host, port, ai) {
	        var _this = this;
	        this._isHost = false;
	    ...
	    Game.prototype.rollResultMessageReceived = function (message) {
	        ...
	        if (!this.getCurrentPlayer()) {
	            ...
	            var attackRolls = this.attackDetails.attack.payload[2];
	            var defendRolls = this.attackDetails.defend.payload;
	            // If we've got all the dice rolls, calculate the result.
	            if (this.attackDetails.rolls.length === attackRolls + defendRolls) {
	            }
	        }
	    };
	    return Game;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConnectionView = (function (_super) {
	    ...
	    ConnectionView.prototype.connectButtonClick = function (e) {
	        var _this = this;
	        var hostname = this.$('#connection-host').val(), port = this.$('#connection-port').val(), ai = this.$('#connection-ai')[0].checked;
	        this.disableInputs();
	        this.model.showToast('Connecting...');
	        this.model.connect(hostname, port, ai).catch(function (message) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ArmyCountSelectView = (function (_super) {
	    ...
	    ArmyCountSelectView.prototype.show = function () {
	        this.render();
	        this.$el.removeClass('hidden');
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Handlebars = __webpack_require__(40);
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(depth0,helpers,partials,data) {
	  var stack1, helper, functionType="function", helperMissing=helpers.helperMissing, escapeExpression=this.escapeExpression, buffer = "			<div class=\"card\">\n				";
	  ...
	  return "<button type=\"button\" class=\"cancel-button\">Cancel</button>";
	  },"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
