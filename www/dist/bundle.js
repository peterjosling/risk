...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = (function (_super) {
	    ...
	    function Game(options) {
	        _super.call(this, options);
	        this.playerList = new Collection();
	        this.map = new Map();
	    ...
	    Game.prototype.startServer = function (port) {
	        var _this = this;
	        this._isHost = true;
	    ...
	    Game.prototype.handleAttackMessage = function (message) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ConnectionView = (function (_super) {
	    ...
	    ConnectionView.prototype.connectButtonClick = function (e) {
	        var _this = this;
	        var hostname = this.$('#connection-host').val(), port = this.$('#connection-port').val();
	        this.disableInputs();
	        this.model.showToast('Connecting...');
	        this.model.connect(hostname, port).catch(function (message) {
	    ...
	    ConnectionView.prototype.hostButtonClick = function (e) {
	        var _this = this;
	        var port = +this.$('#host-port').val();
	        this.disableInputs();
	        this.model.showToast('Starting server...');
	        this.model.startServer(port).catch(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var View = __webpack_require__(2);
	var PlayerListView = __webpack_require__(17);
	var MapView = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var View = __webpack_require__(2);
	var PlayerListItemView = __webpack_require__(25);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(38), __webpack_require__(37), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SafeString = __webpack_require__(40)["default"];
	var Exception = __webpack_require__(41)["default"];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Utils = __webpack_require__(42);
	var Exception = __webpack_require__(41)["default"];
	var COMPILER_REVISION = __webpack_require__(39).COMPILER_REVISION;
	var REVISION_CHANGES = __webpack_require__(39).REVISION_CHANGES;
	var createFrame = __webpack_require__(39).createFrame;
